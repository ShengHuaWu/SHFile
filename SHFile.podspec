#
#  Be sure to run `pod spec lint SHFile.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # ―――  Spec License  ――――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  #
  #  Licensing your cod""e is important. See http://choosealicense.com for more info.
  ...
  s.source       = { :git => "https://github.com/ShengHuaWu/SHFile.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "SHFile/Classes/*.{h,m}"
